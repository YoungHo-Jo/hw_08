...
{
	GPIO_Write(GPIOE, LCD_Reg);        //write data

	GPIO_ResetBits(GPIOC, GPIO_Pin_6);  //cs low
	GPIO_ResetBits(GPIOD, GPIO_Pin_13);   //rs low
	GPIO_ResetBits(GPIOD, GPIO_Pin_14); //reset wr
	GPIO_SetBits(GPIOD, GPIO_Pin_14);   //set wr
}

void LCD_WR_DATA(uint16_t LCD_Data)
{
	GPIO_Write(GPIOE, LCD_Data);        //write data

	GPIO_ResetBits(GPIOC, GPIO_Pin_6);  //cs low
	GPIO_SetBits(GPIOD, GPIO_Pin_13);   //rs high
	GPIO_ResetBits(GPIOD, GPIO_Pin_14); //reset wr
	GPIO_SetBits(GPIOD, GPIO_Pin_14);   //set wr
}
...
uint16_t LCD_ReadReg(uint16_t LCD_Reg)
{
	...
	GPIO_ResetBits(GPIOC, GPIO_Pin_6);  //cs low
	GPIO_SetBits(GPIOD, GPIO_Pin_13);   //rs high
	GPIO_ResetBits(GPIOD, GPIO_Pin_15); //reset rd
	GPIO_SetBits(GPIOD, GPIO_Pin_15);   //set rd
